...
# The vendor does not document whether a daily FX bar is stamped at the session open or
# its close, so a bar labelled D is charged as usable only at D+1 17:00 New York.
FX_AVAILABLE = ("America/New_York", pd.Timedelta(days=1, hours=17))

# A panel row is anchored at the New York close, the last of the four market closes.
# Every price on the row has to have printed before it.
